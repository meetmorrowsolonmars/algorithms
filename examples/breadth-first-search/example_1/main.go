...
// Имеется шахматная доска M*N. Координатами (R1, C1) заданы начальные координаты фигуры.
// Координатам (R2, C2) задана конечная точка, в которую нужно прийти. На поле есть мины помеченные "x".
// Фигура ходит как обычный конь в шахматах.
// Найти путь из точки (R1, C1) в точку (R2, C2) и вывести его.
